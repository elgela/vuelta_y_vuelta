...
<body>
        ...
        <div class="row gx-0 wow fadeIn" data-wow-delay="0.1s">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="index.html"
                    ...
                    <img src="img/logo.png" alt="logo_vuelta_y_vuelta" id="logo">
                </a>
            </div>
            <div class="col-lg-9">
                <div class="row gx-0 d-none d-lg-flex bg-dark">
                    <div class="col-6 px-5 text-start">
                        <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                            ...
                            <!-- <p class="mb-0">yanifranzino@hotmail.com</p> -->
                            <a href="mailto:yanifranzino@hotmail.com?subject=Consulta">Enviar e-mail</a>
                        </div>
                    </div>
                    <div class="col-6 px-5 text-end">
                        <div class="h-100 d-inline-flex align-items-center py-2">
                            ...
                            <!-- <p class="mb-0">2494 567 863</p> -->
                            <a href="https://wa.me/2494567863" target="_blank">Escribinos</a>
                        </div>
                    </div>
                </div>
                <nav class="navbar navbar-expand-lg navbar-dark p-3 p-lg-0 px-lg-5" style="background: #111111;">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="d-none d-lg-flex align-items-center py-2">
                            <a class="btn btn-outline-secondary btn-square rounded-circle ms-2"
                                href="https://www.facebook.com/profile.php?id=100063506804709&sk=about&locale=es_LA" target="_blank">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="btn btn-outline-secondary btn-square rounded-circle ms-2"
                                href="https://www.instagram.com/vueltayvueltarestaurante?fbclid=IwY2xjawMunTBleHRuA2FlbQIxMABicmlkETFMZGFtemE0OGp6aHdBU1g5AR4B1LQKSQ0CQSa9h3k5DmAVzoc3X6MIC3phv9xgbC2G774x1bDkIz2FpKPLhQ_aem_HX6Ueol76bLOX6vOrPOBtA" target="_blank">
    ...
    <div class="container-fluid position-relative instagram p-0 mt-5">
        <a href="https://www.instagram.com/vueltayvueltarestaurante/" target="_blank"
        ...
        <div class="row g-0">
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid" src="img/ensalada.jpg" alt="ensalada">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                <img class="img-fluid" src="img/guiso_lentejas.jpg" alt="guiso de lentejas">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.3s">
                <img class="img-fluid" src="img/milanesa_papas.jpg" alt="milanesa con papas">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.4s">
                <img class="img-fluid" src="img/pastel_papa.jpg" alt="pastel de papa">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                <img class="img-fluid" src="img/tarta.jpg" alt="tarta">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
                <img class="img-fluid" src="img/tomate-papas-aceituna.jpg" alt="tomate, papas y aceituna">
            </div>
        </div>
    </div>
    <!-- Instagram End -->
